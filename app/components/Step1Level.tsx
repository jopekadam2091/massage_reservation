...
import { 
  ...
  Flame, Droplets, Check, Clock, ChevronRight
} from 'lucide-react';
...
export default function Step1Level({ t, onSelect }: Props) {
  ...
  return (
    <div className="max-w-5xl mx-auto font-sans text-center space-y-4 sm:space-y-6 px-1 sm:px-2">
      
      {/* 🚀 SUB-HEADER: ZVOĽTE SI ÚROVEŇ */}
      <div className="max-w-md mx-auto">
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-extrabold tracking-tight text-[#0B0D22] dark:text-white">
      ...
      {/* 🔮 RESPONZÍVNE KARTY: KLASIK & VIP */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 items-stretch justify-center pt-1">
        
        {/* ====================================================================
            1. KARTA: KLASIK MASÁŽ
            ==================================================================== */}
        <div className="relative flex flex-col group w-full">
          ...
          >
            <div 
              ...
              className="w-full h-full p-5 sm:p-7 flex flex-col justify-between text-left select-none relative z-10 transition-colors"
            >
              <div>
                {/* HORNÝ RIADOK: IKONA + NÁZOV */}
                <div className="flex items-center gap-3.5 mb-3.5">
                  <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-[#38BDF8]/15 border border-[#38BDF8]/30 backdrop-blur-md flex items-center justify-center text-[#0284C7] dark:text-[#38BDF8] shadow-[0_0_18px_rgba(56,189,248,0.25)] shrink-0 transition-transform duration-300 group-hover:scale-105">
                    <ShieldCheck size={24} />
                  </div>
                  <div>
                    ...
                    <h3 className="font-extrabold text-xl sm:text-2xl text-[#0B0D22] dark:text-white tracking-tight leading-tight">
                      {isSK ? 'Klasická Masáž' : 'Classic Massage'}
                    </h3>
                  </div>
                </div>

                {/* ⏱ DOSTUPNÉ DĹŽKY S HODINAMI (30 · 45 · 60) */}
                <div className="my-3.5">
                  <div className="inline-flex items-center gap-2 py-1.5 px-3.5 rounded-full bg-slate-100/90 dark:bg-white/[0.05] border border-slate-200 dark:border-white/10 shadow-xs">
                    <span className="text-[11px] font-semibold text-slate-500 dark:text-slate-400">
                      {isSK ? 'Trvanie:' : 'Duration:'}
                    </span>
                    <div className="flex items-center gap-1.5 text-xs font-bold text-[#0284C7] dark:text-[#38BDF8]">
                      <span className="inline-flex items-center gap-0.5">30<Clock size={12} className="inline ml-0.5" /></span>
                      <span className="text-slate-300 dark:text-slate-600 font-normal">·</span>
                      <span className="inline-flex items-center gap-0.5">45<Clock size={12} className="inline ml-0.5" /></span>
                      <span className="text-slate-300 dark:text-slate-600 font-normal">·</span>
                      <span className="inline-flex items-center gap-0.5">60<Clock size={12} className="inline ml-0.5" /></span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2.5 py-1">
                  <div className="flex items-center gap-2.5 text-xs sm:text-sm text-[#334155] dark:text-[#DDE0F2]">
              ...
              <div className="pt-5 flex justify-center sm:justify-start">
                <button
                  ...
                  className="w-full sm:w-auto min-h-[48px] h-[48px] px-7 rounded-xl bg-[#0F142D] hover:bg-[#161D40] dark:bg-[#070A1E] dark:hover:bg-[#0D1233] border border-[#38BDF8]/50 hover:border-[#38BDF8]/80 shadow-[0_4px_16px_rgba(0,0,0,0.25),0_0_12px_rgba(56,189,248,0.18)] hover:shadow-[0_4px_22px_rgba(56,189,248,0.35)] transition-all duration-200 active:scale-95 cursor-pointer flex items-center justify-center gap-2.5 relative overflow-hidden group/btn"
                >
                  ...
                  <ChevronRight size={16} className="text-[#38BDF8] transition-transform duration-200 group-hover/btn:translate-x-1" />
                </button>
              </div>
        ...
        <div className="relative flex flex-col group w-full">
          ...
          >
            <div 
              ...
              className="w-full h-full p-5 sm:p-7 flex flex-col justify-between text-left select-none relative z-10 bg-gradient-to-b from-[#FF5A7A]/[0.10] via-transparent to-[#EF4444]/[0.05]"
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3.5 mb-3.5">
                  <div className="relative w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-[#FF5A7A]/20 border border-[#FF5A7A]/40 backdrop-blur-md flex items-center justify-center text-[#FF5A7A] shadow-[0_0_20px_rgba(255,90,122,0.4)] shrink-0 transition-transform duration-300 group-hover:scale-105">
                    <Flame size={24} className="fill-[#FF5A7A]/30 text-[#FF5A7A]" />
                  ...
                  <div>
                    <div className="flex items-center gap-1.5">
                      <span className="text-[11px] font-bold uppercase tracking-wider text-[#FF5A7A]">
                    ...
                    <h3 className="font-extrabold text-xl sm:text-2xl bg-gradient-to-r from-[#FF5A7A] via-[#F43F5E] to-[#FB7185] bg-clip-text text-transparent tracking-tight leading-tight">
                      VIP Premium
                    </h3>
                  </div>
                </div>

                {/* ⏱ DOSTUPNÉ DĹŽKY S HODINAMI (45 · 60 · 90) */}
                <div className="my-3.5">
                  <div className="inline-flex items-center gap-2 py-1.5 px-3.5 rounded-full bg-rose-50/90 dark:bg-[#FF5A7A]/[0.08] border border-rose-200/70 dark:border-[#FF5A7A]/25 shadow-xs">
                    <span className="text-[11px] font-semibold text-slate-500 dark:text-rose-300/80">
                      {isSK ? 'Trvanie:' : 'Duration:'}
                    </span>
                    <div className="flex items-center gap-1.5 text-xs font-bold text-[#FF5A7A]">
                      <span className="inline-flex items-center gap-0.5">45<Clock size={12} className="inline ml-0.5" /></span>
                      <span className="text-rose-200 dark:text-[#FF5A7A]/40 font-normal">·</span>
                      <span className="inline-flex items-center gap-0.5">60<Clock size={12} className="inline ml-0.5" /></span>
                      <span className="text-rose-200 dark:text-[#FF5A7A]/40 font-normal">·</span>
                      <span className="inline-flex items-center gap-0.5">90<Clock size={12} className="inline ml-0.5" /></span>
                    </div>
                  </div>
                </div>
              ...
              {/* 👑 AKČNÉ TLAČIDLO */}
              <div className="pt-5 relative z-10 flex justify-center sm:justify-start">
                <button
                  type="button"
                  onClick={(e) => {
                    e.stopPropagation();
                  ...
                  className="w-full sm:w-auto min-h-[48px] h-[48px] px-7 rounded-xl bg-[#200A19] hover:bg-[#2C0E23] dark:bg-[#12040E] dark:hover:bg-[#1D0717] border border-[#FF5A7A]/50 hover:border-[#FF5A7A]/80 shadow-[0_4px_16px_rgba(0,0,0,0.25),0_0_12px_rgba(255,90,122,0.18)] hover:shadow-[0_4px_22px_rgba(255,90,122,0.35)] transition-all duration-200 active:scale-95 cursor-pointer flex items-center justify-center gap-2.5 relative overflow-hidden group/vipbtn"
                >
                  ...
                  <ChevronRight size={16} className="text-[#FF5A7A] transition-transform duration-200 group-hover/vipbtn:translate-x-1" />
                </button>
              </div>
